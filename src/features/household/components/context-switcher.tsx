    ...
    <Sheet>
      <SheetTrigger asChild>
        <button
          ...
          className="pressable-tint rounded-inner border-border bg-surface text-text flex h-11 w-36 max-w-full items-center gap-2 border px-3 text-sm font-medium"
        >
          {activeHousehold ? (
