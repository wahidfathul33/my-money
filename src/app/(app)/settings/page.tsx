...
// task 20 replaced that page with the real dashboard — the app needs
// exactly one durable sign-out affordance regardless of which task owns
// the dashboard's own content at any moment.
