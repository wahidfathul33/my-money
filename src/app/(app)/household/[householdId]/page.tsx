...
export default async function HouseholdSummaryPage({
  ...
  // line, separate from this list — see that component's doc comment. These
  // 3 stay locked until tasks 11 and 12 give them somewhere to go —
  // docs/10-ux-states.md §2.1 / todo.md: "Undang anggota" nonaktif sampai
  // task 11; "Tandai pengeluaran" & "Bagikan" nonaktif sampai task 12.
